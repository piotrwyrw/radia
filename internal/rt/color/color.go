...
func (color *Color) SDLColor() (uint8, uint8, uint8) {
	return math.Clamp[float64, uint8](float64(0), float64(255), color.R*255.0),
		math.Clamp[float64, uint8](float64(0), float64(255), color.G*255.0),
		math.Clamp[float64, uint8](float64(0), float64(255), color.B*255.0)
}
